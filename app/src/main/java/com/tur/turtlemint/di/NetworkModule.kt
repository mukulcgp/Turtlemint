...
import com.tur.turtlemint.data.repository.TurtleRepositoryImp
...
import com.tur.turtlemint.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideTurtleRepository(
        appDatabase: AppDatabase,
        retrofitService: RetrofitService
    ): TurtleRepository {
        return TurtleRepositoryImp(appDatabase, retrofitService)
    }
